...
export class CommentController {
    ...
    @Post('create-comment')
    @ApiOperation({ summary: 'Create a new comment', description: 'Creates a new comment for a specific SKU' })
    @ApiQuery({ name: 'skuId', description: 'The SKU ID to comment on', type: 'string' })
    ...
    @ApiQuery({ name: 'commentId', description: 'The ID of the comment to update', type: 'string' })
    ...
    @ApiOperation({ summary: 'Delete a comment', description: 'Deletes an existing comment' })
    @ApiQuery({ name: 'commentId', description: 'The ID of the comment to delete', type: 'string' })
