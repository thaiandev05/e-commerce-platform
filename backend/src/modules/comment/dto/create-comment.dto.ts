...
export class CreateCommentDto {
  ...
  @ApiPropertyOptional({
    description:
      'ID of the comment being replied to (required if isReply is true)',
  ...
  @Length(1, 200, {
    each: true,
    message: 'Each pro must be between 1 and 200 characters',
  })
  pros?: string[];
  ...
  @Length(1, 200, {
    each: true,
    message: 'Each con must be between 1 and 200 characters',
  })
  cons?: string[];
